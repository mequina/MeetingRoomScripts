...
lpadmin -p "NY_HP_LaserJet_300_Color" -v "lpd://$IP-ADDRESS/" -D "NY HP LaserJet 300 Color" -L "NYC Printer by Freight Elevator" -P "/Library/Printers/PPDs/Contents/Resources/HP LJ 300-400 color MFP M375-M475.gz" -E
